...
subtitle:    	Quick overview of me and project I have worked on

theme:		night # default/beige/blood/moon/night/serif/simple/sky/solarized
trans:		none # default/cube/page/concave/zoom/linear/fade/none

horizontal:	</section></section><section markdown="1" data-background="http://projectpages.github.io/project-pages/img/logos/melon.png"><section markdown="1">
vertical:		</section><section markdown="1">
---
<section markdown="1" data-background="http://projectpages.github.io/project-pages/img/logos/melon.png"><section markdown="1">
## {{ page.title }}
