...
* Stonger on the Computational Side more then Mechanical or Materials
--horizontal
# Some Skills
* Area: Computational Materials Science with a Focus on Materials Informatics
* Work Environment: Mainly MATLAB, R and MAPLE
* Topics of Interest:
  - *Spatial Correlations*      - *Machine Learning*
  - *Image/Signal Processing*   - Matrix  Linear Algebra
  - Modelling and Simulation    - Parallelization/Sequentialization
  - Graph Analysis              - **Web Development & Automation**
--horizontal
